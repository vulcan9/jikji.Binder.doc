...
function link(page, target){
	...
	if(!isURL){
		page = '/jikji.Binder.doc/' + page.replace(/\.md$/, '');
	}
...
$( document ).ready(function() {
	...
	var menu = [
		...
		{type: 'link', target: '_blank', label: '새로운 APP ID 지정하기', url: 'https://github.com/vulcan9/jikji.Binder.doc/wiki/Jik ji Binder 새로운 APP ID 지정하기 (xxx_cdbook_cd_appid 버전)'},
		{label: '추가/변경 사항'},
